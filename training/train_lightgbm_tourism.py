...
def main():
    ...
    joblib.dump(model, r"models\tourism\lightgbm_model.pkl")
    
    with open(r"reports\tourism\lightgbm_metrics.json", 'w') as f:
        json.dump(metrics, f, indent=4)
        
    df_pred = df_test[['series_name', 'time_index', 'value']].copy()
    df_pred['prediction'] = y_pred
    df_pred.to_parquet(r"reports\tourism\lightgbm_predictions.parquet", index=False)
