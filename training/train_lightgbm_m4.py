...
def main():
    ...
    joblib.dump(model, r"models\m4_daily\lightgbm_m4.pkl")
    
    with open(r"reports\m4_daily\lightgbm_metrics.json", 'w') as f:
        json.dump(metrics, f, indent=4)
        
    df_pred = df_test[['series_name', 'time_index', 'value']].copy()
    df_pred['prediction'] = y_pred
    df_pred.to_parquet(r"reports\m4_daily\lightgbm_predictions.parquet", index=False)
