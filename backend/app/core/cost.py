...
class CostAttributionService:
    def log_usage(self, tenant_id: str, user_id: str, resource_type: str, resource_name: str, units: float):
        usage = ResourceUsage(
            tenant_id=tenant_id,
            user_id=user_id,
    ...
    def generate_billing_export(self, tenant_id: str, start_date: str, end_date: str):
